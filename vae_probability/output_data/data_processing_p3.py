# Input file path
input_file = "vae_probability/output_data/generated_samples_176625_Brain_FINAL.csv"

# Output file path
output_file = "vae_probability/output_data/generated_samples_176625_Brain_FINAL.csv"
